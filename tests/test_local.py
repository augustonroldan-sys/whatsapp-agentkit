...
"""
Probá a Sofia sin necesitar WhatsApp.
Simula una conversación en la terminal como si fueras un cliente de HeFe Uniformes.
"""
...
async def main():
    ...
    print()
    print("=" * 55)
    print("   HeFe Uniformes — Test Local (Sofia)")
    print("=" * 55)
    print()
    ...
    while True:
        ...
        # Generar respuesta de Sofia
        print("\nSofia: ", end="", flush=True)
        respuesta = await generar_respuesta(mensaje, historial)
        print(respuesta)
        print()

        # Guardar mensaje del cliente y respuesta de Sofia
